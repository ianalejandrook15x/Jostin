...
let texto = `🚩 *Instalación de Jostin*
...
git clone https://github.com/ianalejandrook15x/Jostin && cd Jostin && yarn install && npm install 
...
await delay(1000 * 1)
m.reply('git clone https://github.com/ianalejandrook15x/Jostin && cd Jostin && yarn install && npm install ')
await delay(1000 * 1)
m.reply('ls')
await delay(1000 * 1)
m.reply('npm start')
